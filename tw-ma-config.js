...
(function (global) {
    ...
    const BROWSER_LABELS = {
        de: {
            ...
            // ── Modul Fotos (Etappe 6 / B6.1: Raum + Phase + Wand-Raster) ──
            'fotos.raumliste.titel': 'Raeume',
            'fotos.raumliste.hinweis': 'Lege fuer jeden zu fotografierenden Raum einen eigenen Eintrag an. Pro Raum kannst du dann in 3 Phasen (Rohzustand / Vorarbeiten / Fertigstellung) Wand-fuer-Wand dokumentieren.',
            'fotos.raumliste.lade': 'Raeume werden geladen ...',
            'fotos.raumliste.leer.titel': 'Noch keine Raeume',
            'fotos.raumliste.leer.text': 'Tippe oben auf "Neuer Raum" um den ersten Raum dieser Baustelle anzulegen.',
            'fotos.raum.neu': 'Neuer Raum',
            'fotos.raum.waende': '{n} Waende',
            'fotos.raum.bearbeiten': 'Raum bearbeiten',
            'fotos.raum.loeschen': 'Raum loeschen',
            'fotos.raum.loeschen.bestaetigen': 'Raum "{name}" wirklich loeschen? Damit gehen auch alle bisherigen Fotos zu diesem Raum verloren.',
            'fotos.raum.loeschen.fehler': 'Loeschen fehlgeschlagen:',
            ...
            'fotos.raum.feld.bezeichnung.platzhalter': 'z.B. Bad EG, Kueche, Gaeste-WC',
            'fotos.raum.feld.nummer': 'Raum-Nummer (optional)',
            'fotos.raum.feld.nummer.platzhalter': 'z.B. 1.04',
            'fotos.raum.feld.geschoss': 'Geschoss',
            'fotos.raum.feld.wandzahl': 'Anzahl Waende',
            'fotos.raum.feld.zusaetze': 'Zusaetzliche Flaechen',
            'fotos.raum.boden': 'Boden',
            'fotos.raum.decke': 'Decke',
            'fotos.raum.fehler.bezeichnung': 'Bitte eine Raum-Bezeichnung angeben.',
            'fotos.raum.fehler.baustelle': 'Baustellen-Zuordnung fehlt - bitte App neu laden.',
            'fotos.raum.fehler.storage': 'Speicher nicht bereit. Bitte App neu starten.',
            'fotos.raum.fehler.speichern': 'Speichern fehlgeschlagen.',
            'fotos.raum.abbrechen': 'Abbrechen',
            'fotos.raum.speichern': 'Speichern',
            'fotos.raum.speichern.laeuft': 'Speichere ...',
            'fotos.phase.intro': 'Waehle eine Phase, um Wand-fuer-Wand zu dokumentieren.',
            ...
            'fotos.phase.vorarbeiten.subtitle': 'Abdichtung / Grundierung / Estrich',
            ...
            'fotos.boden': 'Boden',
            'fotos.decke': 'Decke',
            'fotos.bald.titel': 'Foto-Aufnahme kommt gleich',
            'fotos.bald.text': 'Die Kamera-Funktion wird im naechsten Baustein (B6.2) eingebaut. Aktuell kannst du Raeume + Phasen + Waende strukturieren.',
            'fotos.bald.ok': 'Verstanden',
            // ── Modul Fotos B6.2: Foto-Aufnahme ──
            'fotos.aufnahme.lade': 'Fotos werden geladen ...',
            'fotos.aufnahme.komprimiere': 'Foto wird verarbeitet ...',
            'fotos.aufnahme.wiederholen': 'Wiederholen',
            'fotos.aufnahme.verwenden': 'Verwenden',
            'fotos.aufnahme.abbrechen': 'Abbrechen',
            'fotos.aufnahme.neu': 'Neu fotografieren',
            'fotos.aufnahme.loeschen': 'Loeschen',
            'fotos.aufnahme.ok': 'OK',
            'fotos.aufnahme.loeschen.bestaetigen': 'Foto wirklich loeschen?',
            'fotos.aufnahme.editor.bald': 'Markieren und Zeichnen kommt im naechsten Baustein (B6.3) - dann kannst du Crop-Ausschnitte und farbige Markierungen direkt aufs Foto malen.',
            'fotos.aufnahme.fehler.storage': 'Speicher nicht bereit. Bitte App neu starten.',
            'fotos.aufnahme.fehler.komprimierung': 'Foto konnte nicht verarbeitet werden:',
            'fotos.aufnahme.fehler.speichern': 'Speichern fehlgeschlagen:',
            'fotos.aufnahme.fehler.loeschen': 'Loeschen fehlgeschlagen:',
            'fotos.aufnahme.status.pending':  'Wartet auf Sync',
            'fotos.aufnahme.status.uploaded': 'Hochgeladen',
            'fotos.aufnahme.status.fehler':   'Sync-Fehler',
            // ── Modul Fotos B6.3: Foto-Editor ──
            ...
            'fotos.editor.crop.reset': 'Crop zuruecksetzen',
            'fotos.editor.crop.aktiv': 'Ausschnitt gesetzt',
            'fotos.editor.crop.hinweis': 'Ziehe ein Rechteck im Bild',
            'fotos.editor.rueckgaengig': 'Zurueck',
            'fotos.editor.alle.bestaetigen': 'Alle Markierungen und Zuschnitt entfernen?',
            'fotos.editor.speichern': 'Uebernehmen',
            'fotos.editor.speichern.laeuft': 'Speichere ...',
            'fotos.editor.striche': '{n} Strich(e)',
            'fotos.editor.keine.aenderungen': 'Keine Aenderungen',
            'fotos.editor.zugeschnitten': 'zugeschnitten',
            'fotos.editor.legende': 'Farb-Legende',
            'fotos.editor.legende.intro': 'Diese Farbzuordnungen sind als Gedankenstuetze gedacht. Verwende moeglichst die gleichen Farben wie das Buero, damit Thomas die Fotos richtig versteht. Du musst dich aber nicht zwingend daran halten.',
            'fotos.editor.fehler.bild': 'Foto konnte nicht verarbeitet werden.',
            // Markierungs-Farben (Namen)
            ...
            // Farbzuordnungen (Beschreibungen)
            'fotos.editor.zuord.boden':         'Bodenflaeche',
            'fotos.editor.zuord.wand':          'Wandflaeche',
            'fotos.editor.zuord.sockel':        'Sockelhoehe / Spritzwasser',
            'fotos.editor.zuord.laibung':       'Laibung',
            'fotos.editor.zuord.abdichtung':    'Abdichtungsflaeche',
            'fotos.editor.zuord.dichtungsband': 'Dichtungsband',
            'fotos.editor.zuord.ecken':         'Innen-/Aussenecken',
            'fotos.editor.zuord.manschetten':   'Wand-/Bodenmanschetten',
            'fotos.editor.zuord.gefliest':      'Gefliest fertig',
            'fotos.editor.zuord.installation':  'Installation / Sanitaer',
            'fotos.editor.zuord.dehnung':       'Dehnungsfuge',
            'fotos.editor.zuord.schienen':      'Profilschienen',
            'fotos.editor.zuord.ablagen':       'Ablagen / Eckregale',
            // ── Modul Fotos B6.4: Sprach-Notiz ──
            'fotos.notiz.titel':            'Sprach-Notiz',
            'fotos.notiz.neu':              'Notiz aufnehmen',
            'fotos.notiz.bearbeiten':       'Notiz bearbeiten',
            'fotos.notiz.sprache':          'Aufnahme-Sprache',
            'fotos.notiz.text':             'Notiz-Text',
            'fotos.notiz.platzhalter':      'Tippe oder spreche deine Notiz hier ...',
            'fotos.notiz.start':            'Aufnahme starten',
            'fotos.notiz.stop':             'Aufnahme stoppen',
            'fotos.notiz.aktiv':            'Aufnahme laeuft ...',
            'fotos.notiz.aktiv.hinweis':    'Sprich deutlich, in normaler Lautstaerke. Tippe Stop, wenn du fertig bist.',
            'fotos.notiz.inaktiv':          'Aufnahme bereit',
            'fotos.notiz.inaktiv.hinweis':  'Tippe das Mikrofon, um deine Notiz zu sprechen.',
            'fotos.notiz.live':             'Live-Transkription...',
            'fotos.notiz.uebersetzung.hinweis': 'Wird beim Speichern automatisch ins Deutsche uebersetzt fuer das Buero.',
            'fotos.notiz.kein.support':     'Spracheingabe wird von diesem Browser nicht unterstuetzt. Du kannst die Notiz manuell eintippen.',
            'fotos.notiz.fehler.kein.support': 'Spracheingabe nicht verfuegbar.',
            'fotos.notiz.fehler.aufnahme':  'Fehler bei der Aufnahme:',
            'fotos.notiz.loeschen.bestaetigen': 'Notiz wirklich loeschen?',
            'fotos.notiz.speichern':        'Speichern',
